...
class youtubeRSS():
	def __init__(self,city):
		...
		self.city = city
		self.url = "http://gdata.youtube.com/feeds/api/videos?location="+ myGeoLocationCities.getLatLon(city) +"&location-radius=50km&time=today&orderby=published&max-results=50" 	
		self.lastRhythm = 0
	...
	def getData(self, arg):
		...
		try:	
			...
			print "totalVideos: "+str(totalVideos)
